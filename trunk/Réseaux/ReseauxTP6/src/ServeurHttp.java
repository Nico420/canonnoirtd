...
public class ServeurHttp
{
    ...
    static String racine = "/home-reseau/ndesfeux/workspace/ReseauxTP6/src/www";  // sous répertoire racine du serveur
	...
	try {socket = new ServerSocket(port);System.out.println(socket);} catch (IOException e){
