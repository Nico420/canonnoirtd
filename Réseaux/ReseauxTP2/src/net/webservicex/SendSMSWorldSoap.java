 ...
 * 
 */
@WebService(name = "SendSMSWorldSoap", targetNamespace = "http://www.webserviceX.NET")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface SendSMSWorldSoap {
     ...
     */
    @WebMethod(action = "http://www.webserviceX.NET/sendSMS")
    @WebResult(name = "sendSMSResult", targetNamespace = "http://www.webserviceX.NET")
    @RequestWrapper(localName = "sendSMS", targetNamespace = "http://www.webserviceX.NET", className = "net.webservicex.SendSMS")
    @ResponseWrapper(localName = "sendSMSResponse", targetNamespace = "http://www.webserviceX.NET", className = "net.webservicex.SendSMSResponse")
